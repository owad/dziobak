...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.domain'
        db.add_column(u'cs_user_company', 'domain',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Company.slug'
        db.add_column(u'cs_user_company', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.domain'
        db.delete_column(u'cs_user_company', 'domain')

        # Deleting field 'Company.slug'
        db.delete_column(u'cs_user_company', 'slug')
