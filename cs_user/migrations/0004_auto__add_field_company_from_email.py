...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.from_email'
        db.add_column(u'cs_user_company', 'from_email',
                      self.gf('django.db.models.fields.EmailField')(default=None, max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.from_email'
        db.delete_column(u'cs_user_company', 'from_email')
    ...
    models = {
        ...
        u'cs_user.company': {
            ...
            'from_email': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '75', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
