...
ADMINS = (
    ('Łukasz Lechowicz', 'llechowicz@gmail.com'),
)
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'localhost:8000', '54.228.212.183', 'dziobak.lechkom.pl', 'www.dziobak.lechkom.pl']
...
SECRET_KEY = 'aon1ue301273a!ysi2!43z-dx&9w^cnc^*nnqanj#+xbd@h-ca'
...
MIDDLEWARE_CLASSES = (
    ...
    'base.middleware.UserRequiredMiddleware',
