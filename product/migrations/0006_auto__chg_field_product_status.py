...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.status'
        db.alter_column(u'product_product', 'status', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Product.status'
        db.alter_column(u'product_product', 'status', self.gf('django.db.models.fields.CharField')(max_length=64))
