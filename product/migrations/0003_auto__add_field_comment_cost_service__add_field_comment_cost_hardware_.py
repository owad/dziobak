...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.cost_service'
        db.add_column(u'product_comment', 'cost_service',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Comment.cost_hardware'
        db.add_column(u'product_comment', 'cost_hardware',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Comment.cost_transport'
        db.add_column(u'product_comment', 'cost_transport',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.cost_service'
        db.delete_column(u'product_comment', 'cost_service')

        # Deleting field 'Comment.cost_hardware'
        db.delete_column(u'product_comment', 'cost_hardware')

        # Deleting field 'Comment.cost_transport'
        db.delete_column(u'product_comment', 'cost_transport')
