...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.status_changed'
        db.add_column(u'product_comment', 'status_changed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.status_changed'
        db.delete_column(u'product_comment', 'status_changed')
    ...
    models = {
        ...
        u'cs_user.company': {
            ...
            'domain': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'product.comment': {
            ...
            'cost_hardware': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'cost_service': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'cost_transport': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'status_changed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'product.product': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cs_user.Company']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'key': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'max_cost': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2000'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cs_user.User']"}),
