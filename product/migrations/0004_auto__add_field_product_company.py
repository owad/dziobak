...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'product_product', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cs_user.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.company'
        db.delete_column(u'product_product', 'company_id')
